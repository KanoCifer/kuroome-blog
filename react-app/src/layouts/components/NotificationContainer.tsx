  ...
  const toast = notifications.map((n, i) => {
    ...
    return (
      <motion.div
        ...
        className="squircle border-border bg-paper/80 text-ink absolute top-0 left-1/2 flex h-18 w-60 -translate-x-1/2 items-center justify-between gap-3 border shadow-xl backdrop-blur-sm transition-colors duration-200"
      >
