    ...
    <div className="flex items-center justify-center gap-4">
      {socialLinks.map((social) => (
        <a
          ...
          className="group border-border/50 bg-paper/80 text-muted hover:border-accent/50 hover:bg-accent/10 hover:text-accent relative flex h-12 w-12 items-center justify-center rounded-2xl border shadow-sm backdrop-blur-sm transition-all duration-300 hover:-translate-y-1 hover:shadow-md"
        >
