...
export function DashboardSheet({
  ...
  return (
    <motion.div
      ...
      className="bg-paper border-border/40 fixed inset-x-0 bottom-0 z-30 flex flex-col overflow-hidden rounded-t-3xl border-t shadow-[0_-8px_28px_color-mix(in_oklch,var(--ink)_10%,transparent)]"
    >
      {/* Drag handle */}
      <div
        role="button"
