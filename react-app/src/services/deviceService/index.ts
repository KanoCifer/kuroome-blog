...
export const deviceService = (): DeviceService => {
  ...
  return {
    ...
    updateDevice: async (
      ...
      const res: AxiosResponse<Device> = await gateway.updateDevice(
        device_id,
        data,
      );
      return extractData(
    ...
    updateDeviceStatus: async (
      ...
      const res: AxiosResponse<Device> = await gateway.updateDeviceStatus(
        device_id,
        status,
      );
      return extractData(
    ...
    updateDeviceReminderConfig: async (
      ...
      const res: AxiosResponse<Device> =
        await gateway.updateDeviceReminderConfig(device_id, reminder_config);
      return extractData(
        res as unknown as { data: ApiResponse<unknown> },
      ) as Device;
    },
    ...
    testNotification: async (device_id: number): Promise<void> => {
      ...
      const res: AxiosResponse<void> =
        await gateway.testNotification(device_id);
      return extractData(
        res as unknown as { data: ApiResponse<unknown> },
      ) as void;
    },
