...
export function MomentTagChip({ name, to }: MomentTagChipProps) {
  ...
  return (
    <Link
      to={target}
      className="text-muted-foreground hover:text-foreground hover:bg-accent inline-flex items-center gap-1 rounded-full px-2.5 py-0.5 font-serif text-[11px] tracking-wide transition-colors"
    >
