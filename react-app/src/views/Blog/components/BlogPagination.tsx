...
export function BlogPagination({
  ...
  return (
    <nav aria-label="博客分页">
      <ul className="border-border/80 bg-card/90 mx-auto inline-flex w-full max-w-full items-center justify-center gap-1 rounded-2xl border p-1.5 shadow-sm backdrop-blur-sm sm:w-fit sm:gap-2">
        {/* Previous */}
        <li>
          <button
