              ...
              {cycleOptions.map((option) => {
                ...
                return (
                  <button
                    ...
                    type="button"
                    onClick={() =>
                      setForm((prev) => ({ ...prev, billingCycle: option.value }))
                    }
            ...
            {formError ? (
              ...
              <div className="flex items-center gap-2">
                ...
                <button
                  ...
                  className="min-h-11 rounded-2xl bg-gradient-to-r from-indigo-600 to-blue-500 px-5 text-sm font-semibold text-white shadow-sm shadow-indigo-500/30 transition hover:from-indigo-500 hover:to-blue-400 disabled:cursor-not-allowed disabled:opacity-60"
                >
