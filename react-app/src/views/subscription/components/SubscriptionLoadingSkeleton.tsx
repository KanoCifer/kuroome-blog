export function SubscriptionLoadingSkeleton() {
  return (
    <div className="space-y-6">
      {/* Card skeleton */}
      <div className="border-border bg-card animate-pulse rounded-xl border p-6 shadow-[0_12px_40px_rgb(0,0,0,0.06)]">
        <div className="mb-6 flex items-start justify-between">
          <div className="flex items-center gap-4">
            <div className="bg-muted h-14 w-14 rounded-2xl" />
            <div className="space-y-2">
              <div className="bg-muted h-5 w-32 rounded-full" />
