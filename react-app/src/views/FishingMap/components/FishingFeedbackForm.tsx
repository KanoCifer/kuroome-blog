  ...
  return (
    <AnimatePresence>
      ...
      <motion.aside
        ...
        className="bg-card border-border fixed inset-x-0 bottom-0 z-50 flex h-auto max-h-[90dvh] flex-col rounded-t-2xl border-t shadow-2xl sm:bottom-auto sm:top-1/2 sm:left-1/2 sm:right-auto sm:max-w-md sm:-translate-x-1/2 sm:-translate-y-1/2 sm:rounded-2xl sm:border"
        role="dialog"
        aria-label="钓鱼反馈"
      >
