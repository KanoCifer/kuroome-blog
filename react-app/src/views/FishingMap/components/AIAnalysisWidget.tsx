...
export function AIAnalysisWidget({ onGenerate }: AIAnalysisWidgetProps) {
  ...
  return (
    <>
      <div className="fixed right-3 bottom-24 z-50 sm:right-6 sm:bottom-24">
        <AnimatePresence mode="wait">
          {analysisOpen && (
            <motion.div
              ...
              className="group squircle relative mb-3 w-[calc(100vw-1.5rem)] max-w-sm overflow-hidden rounded-3xl border border-white/20 bg-linear-to-br from-white/80 to-white/40 shadow-2xl backdrop-blur-sm sm:w-[calc(100vw-3rem)] dark:border-gray-700/50 dark:from-gray-900/80 dark:to-gray-800/40"
            >
              {/* Decorative blobs */}
