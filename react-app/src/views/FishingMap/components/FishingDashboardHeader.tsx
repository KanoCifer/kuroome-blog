    ...
    <header className="border-border/40 bg-card/80 sticky top-0 z-30 border-b backdrop-blur-sm">
      <div className="flex items-center justify-between px-4 py-3 sm:px-5">
        ...
        <button
          ...
          className={`border-border bg-card hover:bg-accent text-foreground inline-flex items-center gap-2 rounded-full border px-3 py-1.5 text-sm transition-colors ${
