      ...
      <div className="flex flex-col">
        ...
        <div className="px-6 py-5">
          ...
          <button
            ...
            disabled={loading}
            className="bg-primary text-primary-foreground hover:bg-primary/90 focus-visible:ring-ring inline-flex w-full cursor-pointer items-center justify-center gap-1.5 rounded-lg px-4 py-2.5 text-sm font-medium transition-colors focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:outline-none disabled:cursor-not-allowed disabled:opacity-60"
          >
            {loading && (
              <svg
          ...
          {result && (
            <div className="mt-5 space-y-3">
              ...
              <div className="relative">
                <textarea
                  className="bg-muted border-border text-foreground block w-full resize-none rounded-lg border px-3 py-2 pr-10 font-mono text-[11px] leading-relaxed outline-none"
                  rows={4}
                  readOnly
                  value={result.token}
                />
                <button
                  type="button"
                  className="text-muted-foreground hover:bg-muted hover:text-foreground absolute top-2 right-2 cursor-pointer rounded-md p-1.5 transition-colors"
                  title={copied ? '已复制' : '复制'}
                  onClick={handleCopy}
                >
                  {copied ? (
