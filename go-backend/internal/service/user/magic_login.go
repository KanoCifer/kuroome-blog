...
func (s *AuthService) SendMagicLoginEmail(ctx context.Context, email, mode, deviceID string) bool {
...
func (s *AuthService) magicLoginLink(token, mode string) string {
...
func (s *AuthService) AuthenticateMagicLogin(ctx context.Context, token string) (*model.User, *model.Profile, error) {
...
func (s *AuthService) finishNomuLogin(ctx context.Context, hex string, u *model.User, p *model.Profile) {
	if s.redis == nil {
		return
	}
...
func (s *AuthService) PollNomuLogin(ctx context.Context, deviceID string) (*NomuLoginState, error) {
