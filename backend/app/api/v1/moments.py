...
async def get_public_moment(
    ...
    moment = await state.moment_svc.get_public_moment(moment_id)
...
async def get_admin_moment(
    ...
    moment = await state.moment_svc.get_admin_moment(moment_id)
    return APIResponse(data={"moment": moment})
...
async def delete_moment(
    ...
    await state.moment_svc.delete_moment(moment_id)
