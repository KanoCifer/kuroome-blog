...
def downgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "bookid", sa.VARCHAR(length=50), autoincrement=False, nullable=True
        ),
        sa.Column(
            "cover", sa.VARCHAR(length=200), autoincrement=False, nullable=True
        ),
        sa.PrimaryKeyConstraint("id", name=op.f("pk_book")),
        sa.UniqueConstraint(
            "bookid",
            name=op.f("uq_book_bookid"),
            postgresql_include=[],
    ...
    op.create_table(
        ...
        sa.Column(
            "book_id", sa.INTEGER(), autoincrement=False, nullable=False
        ),
        sa.Column(
            "iscompleted", sa.BOOLEAN(), autoincrement=False, nullable=False
        ),
        sa.Column(
            "add_date",
    ...
    op.create_index(
        op.f("ix_user_book_update_date"),
        "user_book",
        ["update_date"],
        unique=False,
    )
    op.create_index(
        op.f("ix_user_book_add_date"), "user_book", ["add_date"], unique=False
    )
