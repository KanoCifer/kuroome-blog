...
- Backend layering & API conventions → [docs/rules/architecture.md](docs/rules/architecture.md)
- Go backend specifics → [docs/rules/go-backend.md](docs/rules/go-backend.md)
- Auth contract → [docs/rules/auth.md](docs/rules/auth.md)
