<template>
  ...
  <li
    ...
    :class="
        ...
        : 'bg-paper ring-1 ring-border/60 hover:bg-paper hover:shadow-[0_1px_1px_color-mix(in_oklch,var(--ink)_6%,transparent),0_6px_14px_color-mix(in_oklch,var(--ink)_10%,transparent)] hover:ring-border/80'
    "
  >
    <div class="flex items-start gap-3">
      ...
      >
        ...
        <div class="mt-2 flex flex-wrap items-center gap-1.5">
          ...
          <span
            ...
            :class="overdue ? 'text-destructive font-medium' : 'text-muted-foreground'"
          >
            <svg
              class="h-3 w-3"
              viewBox="0 0 20 20"
      ...
      <div class="flex shrink-0 items-start gap-0.5">
        <button
          ...
          class="text-muted-foreground hover:bg-accent/10 hover:text-accent focus-visible:ring-ring cursor-pointer rounded-md p-1.5 transition-[color,transform] focus-visible:ring-2 focus-visible:ring-offset-1 focus-visible:outline-none active:scale-[0.94] active:not-focus-visible:ring-0"
        ...
        <button
          ...
          :title="`删除 · ${task.title}`"
          class="text-muted-foreground hover:bg-destructive/10 hover:text-destructive focus-visible:ring-ring cursor-pointer rounded-md p-1.5 transition-[color,transform] focus-visible:ring-2 focus-visible:ring-offset-1 focus-visible:outline-none active:scale-[0.94] active:not-focus-visible:ring-0"
