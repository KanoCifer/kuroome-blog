<template>
  <section class="grid grid-cols-2 gap-4">
    ...
    <div
      class="squircle border-border/10 bg-page col-span-2 flex items-center justify-between border p-10 shadow-lg"
    >
      <div>
    ...
    <!-- Active -->
    <div
      class="squircle border-border/10 bg-page flex items-center gap-4 border p-8 shadow-lg"
    >
      <div
