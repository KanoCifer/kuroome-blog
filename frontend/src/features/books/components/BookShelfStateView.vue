...
<template>
  ...
  >
    <div
      class="bg-page border-border w-full max-w-md rounded-2xl border p-8 text-center shadow-sm"
    >
      <div
  ...
  >
    <div
      class="bg-page border-border w-full max-w-md rounded-2xl border p-10 text-center"
    >
      <svg
        viewBox="0 0 88 64"
