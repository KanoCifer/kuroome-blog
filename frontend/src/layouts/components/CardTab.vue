...
<template>
  <div class="space-y-6">
    <div>
      ...
      <!-- 当前选中卡片预览 — 横版 -->
      <div
        class="/60 relative mx-auto aspect-[16/9] w-full max-w-xs overflow-hidden rounded-xl border shadow-sm transition-all duration-200"
      >
        <div
        ...
        <button
          ...
          :class="
            cardIndex === i
              ...
              : '/60 hover:border-accent opacity-70 hover:opacity-100'
          "
          :aria-label="`卡片 ${i + 1}`"
