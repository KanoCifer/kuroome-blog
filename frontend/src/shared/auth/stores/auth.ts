import { createAuthGateway } from '@/shared/auth/api/authGateway';
import { refreshAccessToken } from '@/shared/auth/api/refresh';
import {
  getAccessToken as getToken,
  setAccessToken,
} from '@/shared/auth/tokenService';
import { reconnectWs } from '@/lib/visitorWs';
import type { UserInfo } from '@/shared/auth/types';
import { userCache } from '@/shared/auth/userCache';
