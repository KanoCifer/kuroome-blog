<template>
  ...
  <footer
    ...
    :class="!isEntryView ? 'border-border border-t bg-white dark:bg-black' : 'border-0 bg-transparent'"
  >
    <div
    ...
    >
      ...
      <div class="flex items-center gap-2">
        ...
        <router-link to="/status" class="hover:text-foreground inline-flex items-center gap-1.5 transition-colors">
