...
<template>
  <motion.div
    ...
    class="glass-card flex aspect-square cursor-pointer flex-col justify-between rounded-[2rem] border border-white/40 bg-white/50 p-6 shadow-[0_20px_40px_rgba(21,28,39,0.06)] max-sm:aspect-auto max-sm:h-40 dark:border-white/10 dark:bg-slate-800/40 dark:shadow-none"
    @click="toggleMemo"
  >
    <div
