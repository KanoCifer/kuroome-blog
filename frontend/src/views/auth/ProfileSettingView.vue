<template>
  <div class="mt-12 min-h-screen px-4 py-16">
    <div
      class="mx-auto max-w-2xl rounded-4xl border border-white/20 bg-white/40 p-10 shadow-2xl backdrop-blur-xl dark:border-gray-700/30 dark:bg-gray-900/40"
