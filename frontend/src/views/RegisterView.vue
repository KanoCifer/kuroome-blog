...
<template>
  <div>
    <!-- 标题卡片和注册表单 -->
    <div
      class="mx-auto max-w-md rounded-[40px] bg-blue-50/80 px-12 py-14 shadow-2xl backdrop-blur-md dark:bg-gray-800/80"
    >
      <p
        ...
        <div class="mt-4 flex items-end gap-2">
          <div class="form-group mb-0 flex w-full items-center gap-2">
            ...
            <button
              type="button"
              id="send-code"
              class="h-full cursor-pointer items-center gap-2 rounded-xl bg-blue-600 px-8 py-2.5 font-bold text-white shadow-lg shadow-blue-500/30 transition-colors hover:bg-blue-700 focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 focus:outline-none dark:ring-offset-gray-800"
