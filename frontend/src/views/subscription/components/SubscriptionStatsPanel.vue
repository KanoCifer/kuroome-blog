...
<template>
  ...
  >
    <div class="flex flex-wrap items-start justify-between gap-5">
      <div class="max-w-3xl">
        <p
          class="mb-2 text-xs font-semibold tracking-[0.2em] text-slate-500 uppercase dark:text-slate-400"
        >
          Subscription
        </p>
        <h2
          class="font-serif text-3xl font-semibold text-slate-900 dark:text-white"
        >
          桌面订阅看板
        </h2>
      ...
      <div class="flex flex-wrap items-center gap-3">
        ...
        <button
          type="button"
          class="inline-flex items-center rounded-xl bg-linear-to-r from-[#00288e] to-blue-500 px-4 py-2.5 text-sm font-semibold text-white shadow-lg shadow-indigo-500/30 transition hover:from-[#002574] hover:to-blue-400"
          @click="emit('add')"
        >
          新增订阅
        </button>
    ...
    <div class="mt-6 grid gap-3 md:grid-cols-2 xl:grid-cols-4">
      ...
      >
        ...
        <p
          class="mt-2 text-2xl font-semibold text-indigo-700 dark:text-indigo-300"
        >
