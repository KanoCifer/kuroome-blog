...
<template>
  <section
    class="border-border/80 bg-card rounded-[28px] border p-7 shadow-[0_24px_70px_-34px_rgba(15,23,42,0.45)] backdrop-blur"
  >
    <div class="flex flex-wrap items-start justify-between gap-5">
      ...
      <div class="flex flex-wrap items-center gap-3">
        ...
        <RouterLink
          to="/device-tracker"
          class="border-border bg-card text-card-foreground hover:bg-accent inline-flex items-center gap-2 rounded-xl border px-4 py-2.5 text-sm font-medium transition"
        >
          <svg
    ...
    <div class="mt-6 grid gap-3 md:grid-cols-2 xl:grid-cols-4">
      <article class="border-border/80 bg-card/70 rounded-2xl border p-4">
