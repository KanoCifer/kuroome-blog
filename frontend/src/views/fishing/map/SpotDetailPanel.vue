...
import SpotPhotoLightbox from '@/views/fishing/map/SpotPhotoLightbox.vue';
import type { MapMarker } from '@/types/marker';
import type { SpotDetail } from '@/types/marker';
import type { UpdateFishingSpotPayload } from '@/api/fishing';
