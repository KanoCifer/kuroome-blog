...
const mockBooks = ref<MockBook[]>([
  {
    ...
    cover: null,
    isTop: false,
    readUpdateTime: new Date((now - 86400 * 2) * 1000).toISOString(),
    finishReading: false,
    secret: false,
  ...
  },
  {
    ...
    cover: null,
    isTop: true,
    readUpdateTime: new Date((now - 86400 * 30) * 1000).toISOString(),
    finishReading: true,
    secret: false,
    updated_at: new Date().toISOString(),
    mockProgress: {
  ...
  },
  {
    ...
    cover: null,
    isTop: false,
    readUpdateTime: new Date((now - 86400 * 5) * 1000).toISOString(),
    finishReading: false,
    secret: false,
    updated_at: new Date().toISOString(),
    mockProgress: {
  ...
  },
  {
    ...
    cover: null,
    isTop: false,
    readUpdateTime: new Date((now - 3600) * 1000).toISOString(),
    finishReading: false,
    secret: false,
    updated_at: new Date().toISOString(),
    mockProgress: {
