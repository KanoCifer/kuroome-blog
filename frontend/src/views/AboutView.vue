<template>
  <div
    id="aboutView"
    class="mx-auto flex min-h-full max-w-6xl flex-col items-center justify-center"
  >
    <div
      class="rounded-[40px] border border-gray-100 bg-white/70 p-8 shadow-sm backdrop-blur-sm transition-all duration-300 hover:shadow-md md:p-12 dark:border-gray-700 dark:bg-gray-800/80"
    >
      <div class="flex flex-col items-center gap-8 md:flex-row md:items-center md:gap-12">
        ...
        <!-- 分割线 -->
        <div class="h-72 outline outline-stone-600/80 dark:outline-stone-100/80"></div>
        ...
        <div class="flex-1 space-y-6 text-center md:text-left">
          <div class="space-y-4 text-lg leading-relaxed text-gray-600 dark:text-gray-300">
            <p>
              ...
              你好！欢迎来到我的博客。 目前这个博客还不完善，还有很多内容正在建设中，请多多包涵。
            </p>
            <p>
              我是一名<span
