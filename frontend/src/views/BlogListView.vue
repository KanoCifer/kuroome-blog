      ...
      <div class="min-w-0">
        <div class="space-y-6">
          ...
          <div
            ...
            class="flex flex-col items-center justify-center rounded-2xl border border-dashed border-red-200 bg-red-50 px-6 py-16 text-center backdrop-blur-md dark:border-rose-800 dark:bg-rose-300/30"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
          ...
          <div
            ...
            :class="[
              ...
              post.is_pinned
                ? 'bg-blue-50/80 ring-3 ring-blue-400/60 backdrop-blur-sm dark:bg-slate-800/80 dark:ring-blue-500/40'
          ...
          >
            ...
            <div
              :class="[
                'post-preview prose prose-sm max-w-none truncate overflow-hidden rounded-xl p-4 leading-relaxed',
                post.is_pinned
...
// 获取预览 HTML，限制内容长度
const getPreviewHtml = (html: string, maxLength: number = 100) => {
  if (!html) return "";
  // 创建一个临时容器来安全地处理 HTML
