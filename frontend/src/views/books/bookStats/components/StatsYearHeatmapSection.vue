  ...
  <section v-if="hasData" class="mb-14">
    ...
    <Teleport to="body">
      ...
      >
        <div
          v-if="tooltipCell"
          class="bg-popover text-popover-foreground border-border pointer-events-none fixed z-50 -translate-x-1/2 -translate-y-full rounded-md border px-2.5 py-1.5 text-xs whitespace-nowrap shadow-md"
          :style="{ left: `${tooltipLeft}px`, top: `${tooltipTop}px` }"
        >
          <div class="text-popover-foreground font-medium tabular-nums">
